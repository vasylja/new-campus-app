...
import de.tum.in.newtumcampus.models.Employee;
import de.tum.in.newtumcampus.models.Person;
import de.tum.in.newtumcampus.models.PersonList;
import de.tum.in.newtumcampus.models.StaffListAdapter;
...
public class Staff extends Activity implements OnEditorActionListener, TUMOnlineRequestFetchListener {
	...
	private void displayResults(List<Person> employees) {
		...
		lvStaff.setAdapter(new StaffListAdapter(Staff.this, employees));
		...
		lvStaff.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> a, View v, int position, long id) {
				...
				Intent intent = new Intent(Staff.this, StaffDetails.class);
